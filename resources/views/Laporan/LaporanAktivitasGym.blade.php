...
@section ('title', 'Form Laporan Aktivitas Gym Bulanan')


@section('main')
    <div class=" card my-5 p-3 text-light rounded shadow-lg w-50 mx-auto no-print"  style="background-color: #fb5b21">
        <h3 class="card-title text-center">Filter Pada Laporan</h3>
        <hr style="width: 100%; color: black; height: 1px; background-color:black;" />
        <form action="{{ url('dashboard/laporanAktivitasGymProcess') }}" method="get" enctype="multipart/form-data">
            @csrf
            <div class="form-row mb-2">
                ...
                <button type="submit" class="btn btn-light btn-block mb-4" style="color: #fb5b21">Cari</button>
            </div>
        </form>
    </div>
            ...
            <div class="pb-3 ps-3 pe-3 pt-3 d-flex justify-content-between">
                ...
                @if ($data_gym_activity)
                    <button type="button" class="btn bg-warning text-black mt-2 no-print" onclick="window.print()"><i
                            class="fas fa-solid fa-print fa-fw me-3">Cetak</i></button>
                @endif
        ...
        <div class=" card my-1 p-3 bg-body rounded shadow-sm mt-3">
            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    @empty
                        <div class="alert alert-danger">
                            Laporan Aktivitas Gym Tidak Tersedia
                        </div>
                    @endforelse
                </tbody>
            </table>
