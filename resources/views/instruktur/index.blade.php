...
@section('main')
 ...
 <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h5 class="m-0 font-weight-bold txt-title">Tampilan Data Instruktur</h5>
    </div>
        <div class="card">
    ...
    <div class="card-body'">
      <a href="{{ url('dashboard/createInstruktur')}}" class="btn mb-3 mt-3 ml-2 buttonSubmit">Tambah Instruktur</a>
